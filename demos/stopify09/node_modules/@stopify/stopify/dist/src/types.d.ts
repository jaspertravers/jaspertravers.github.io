...
export declare type Stoppable = (isStop: () => boolean, onStop: () => void, onDone: () => void, opts: RuntimeOpts) => void;
export declare type ElapsedTimeEstimatorName = 'exact' | 'reservoir' | 'velocity' | 'interrupt' | 'countdown';
...
export interface AsyncRun {
    ...
    run(onDone: (result: Result) => void, onYield?: () => void, onBreakpoint?: (line: number) => void): void;
