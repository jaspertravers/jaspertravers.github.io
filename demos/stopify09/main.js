...
function bootstrap() {
  ...
  name1 = "1: first";
  code1 = `line(10,10,100,100,ctx);`
  name2 = "2: clear";
  code2 = `ctx.fillStyle = '#ffffff';\nctx.fillRect(0, 0, 800, 800);`
  name3 = "3: line";
  code3 = `line(10,20,100,110,ctx); //offset line`
  inst1 = {name: name1, code: code1}
  inst2 = {name: name2, code: code2}
  inst3 = {name: name3, code: code3}
